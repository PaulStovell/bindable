...
{
    [TestFixture]
    public class EntryRepositoryTests : RepositoryTestFixture
    {
        [Test]
        public void CanCreateRevisionsForNewEntryBeforeSaving()
        {
            using (var session = Database.SessionFactory.OpenSession())
            {
                ...
                revision.ModerationStatus = RevisionModerationStatus.Passed;
        ...
        public void CreatingNewRevisionsWillAlwaysDuplicateTheLastRevision()
        {
            using (var session = Database.SessionFactory.OpenSession())
            {
                ...
                Assert.AreEqual(RevisionModerationStatus.Passed, secondRevision.ModerationStatus);
        ...
        [ExpectedException(typeof(InvalidOperationException), 
            ExpectedMessage="The method 'set_Body' on type 'Revision' could not be invoked because the instance has been marked as sealed.")]
