<%@ Import Namespace="PaulStovell.Web.Application.Extensions"%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu.ascx.cs" Inherits="PaulStovell.Web.Views.Shared.Partials.Menu" %>
