...
namespace Bindable.Cms.Database.Commands
{
    ...
    [Example("install Server=(local);Database=BindableCMS;Trusted_connection=true")]
    [Example("install Server=(local);Database=BindableCMS;Trusted_connection=true --no-create --no-wait", true)]
    public class InstallCommand : AbstractPromptedCommand
    {
        ...
        protected override void InitializePrompts()
        {
            ...
            ConnectionStringBuilder.InitialCatalog = "BindableCMS";
