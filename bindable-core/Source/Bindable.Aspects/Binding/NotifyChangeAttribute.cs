...
namespace Bindable.Aspects.Binding
{
    ...
    public class NotifyChangeAttribute : OnMethodBoundaryAspect
    {
        ...
        public override void CompileTimeInitialize(MethodBase method)
        {
            ...
            {
                throw new Exception(string.Format("Type '{0}' does not implement ICanRaisePropertyChangedEvents, but the property '{1}' has the BindableProperty attribute applied. Ensure the type '{0}' implements ICanRaisePropertyChangedEvents (preferably explicitly).", method.DeclaringType, method.Name));
            }
