...
namespace Bindable.Core.Language
{
    ...
    public struct SoundEx : IComparable<SoundEx>, IComparable, IEquatable<SoundEx>, IEquatable<string>
    {
        ...
        public static SoundEx Evaluate(string text, int maxDigitsLength)
        {
            ...
            var lastAppended = '\0';
            var lastAppendedEncoded = Score(text[0]);
        ...
        public static bool operator==(SoundEx left, SoundEx right)
        {
        ...
        {
            return Equals(Evaluate(text), comparison);
        }
        ...
        {
            return Equals(other, SoundExComparison.Default);
        }
