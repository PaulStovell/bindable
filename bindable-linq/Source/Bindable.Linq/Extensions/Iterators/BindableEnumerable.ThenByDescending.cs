...
namespace Bindable.Linq
{
	public static partial class BindableEnumerable
	{
	    ...
	    {
	        return ThenByDescending(source, keySelector, DefaultDependencyAnalysis);
	    }
        ...
        {
            return ThenByDescending(source, keySelector, comparer, DefaultDependencyAnalysis);
        }
        ...
        /// <exception cref="T:System.ArgumentNullException">
        /// 	<paramref name="source"/> or <paramref name="keySelector"/> is null.</exception>
        public static IOrderedBindableCollection<TSource> ThenByDescending<TSource, TKey>(this IOrderedBindableCollection<TSource> source, Expression<Func<TSource, TKey>> keySelector, DependencyDiscovery dependencyAnalysisMode) where TSource : class
        {
        ...
        /// <exception cref="T:System.ArgumentNullException">
        /// 	<paramref name="source"/> or <paramref name="keySelector"/> is null.</exception>
        public static IOrderedBindableCollection<TSource> ThenByDescending<TSource, TKey>(this IOrderedBindableCollection<TSource> source, Expression<Func<TSource, TKey>> keySelector, IComparer<TKey> comparer, DependencyDiscovery dependencyAnalysisMode) where TSource : class
        {
            source.ShouldNotBeNull("source");
            keySelector.ShouldNotBeNull("keySelector");
            var result = source.CreateOrderedIterator(keySelector.Compile(), comparer, true);
